...
from hyper_tradfi_pairs.hyperliquid import collect_top_of_book


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Collect 1-second Hyperliquid top-of-book snapshots for the pair-trading assets."
    )
    ...
    parser.add_argument("--interval-seconds", type=float, default=1.0, help="Polling interval.")
    parser.add_argument(
        "--duration-seconds",
        type=float,
        default=None,
